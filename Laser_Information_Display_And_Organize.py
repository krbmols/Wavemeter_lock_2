...
class Application(QWidget):
    def __init__(self):
       ...
       #array of time steps will store the time step the reading was done
        ...
        self.i=[351679,295000,713281,300000,400000,50000,60000,70000] #array to store target values for lasers being used for testing: self.i[0] is the value regarding 
        ...
        self.expected_first.setFont(QFont("Arial",20))
        ...
        self.expected_second.setFont(QFont("Arial",20))
        ...
        self.expected_third.setFont(QFont("Arial",20))
        ...
        self.expected_fourth.setFont(QFont("Arial",20))
        ...
        self.expected_fifth.setFont(QFont("Arial",20))
        ...
        self.expected_sixth.setFont(QFont("Arial",20))
        ...
        self.expected_seventh.setFont(QFont("Arial",20))
        ...
        self.expected_eighth.setFont(QFont("Arial",20))
        ...
        self.first_reading.setFont(QFont("Arial",20))
        ...
        self.second_reading.setFont(QFont("Arial",20))
        ...
        self.third_reading.setFont(QFont("Arial",20))
        ...
        self.fourth_reading.setFont(QFont("Arial",20))
        ...
        self.fifth_reading.setFont(QFont("Arial",20))
        ...
        self.sixth_reading.setFont(QFont("Arial",20))
        ...
        self.seventh_reading.setFont(QFont("Arial",20))
        ...
        self.eighth_reading.setFont(QFont("Arial",20))
        ...
        self.first_sat.setFont(QFont("Arial",20))
        ...
        self.second_sat.setFont(QFont("Arial",20))
        ...
        self.third_sat.setFont(QFont("Arial",20))
        ...
        self.fourth_sat.setFont(QFont("Arial",20))
        ...
        self.fifth_sat.setFont(QFont("Arial",20))
        
        self.sixth_sat=QLabel()
        self.sixth_sat.setText("Saturation of 6th Laser: %f"%self.saturation_levels[5])
        self.sixth_sat.setStyleSheet("color:darkslateblue")
        self.sixth_sat.setFont(QFont("Arial",20))
        
        self.seventh_sat=QLabel()
        self.seventh_sat.setText("Saturation of 7th Laser: %f"%self.saturation_levels[6])
        self.seventh_sat.setStyleSheet("color:darkgoldenrod")
        self.seventh_sat.setFont(QFont("Arial",20))
        ...
        self.eighth_sat.setFont(QFont("Arial",20))
